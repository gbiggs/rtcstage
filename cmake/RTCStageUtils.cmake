...
macro(GET_OS_INFO)
    ...
    if(OS_IS_LINUX)
        if(${CMAKE_SYSTEM_PROCESSOR} STREQUAL "x86_64")
            set(RTCS_LIB_INSTALL_DIR "lib64")
        else(${CMAKE_SYSTEM_PROCESSOR} STREQUAL "x86_64")
            set(RTCS_LIB_INSTALL_DIR "lib")
        endif(${CMAKE_SYSTEM_PROCESSOR} STREQUAL "x86_64")
    endif(OS_IS_LINUX)
    set(RTCS_INCLUDE_INSTALL_DIR
        "include/${PROJECT_NAME_LOWER}-${RTCS_MAJOR_VERSION}.${RTCS_MINOR_VERSION}")
...
macro(DISSECT_VERSION)
    ...
    string(REGEX REPLACE "^([0-9]+).*" "\\1"
        RTCS_MAJOR_VERSION "${RTCS_VERSION}")
    string(REGEX REPLACE "^[0-9]+\\.([0-9]+).*" "\\1"
        RTCS_MINOR_VERSION "${RTCS_VERSION}")
    string(REGEX REPLACE "^[0-9]+\\.[0-9]+\\.([0-9]+)" "\\1"
        RTCS_REVISION_VERSION ${RTCS_VERSION})
    string(REGEX REPLACE "^[0-9]+\\.[0-9]+\\.[0-9]+(.*)" "\\1"
        RTCS_CANDIDATE_VERSION ${RTCS_VERSION})
